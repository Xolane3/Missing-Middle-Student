...
import TechNavBar from '../../../components/technicianNavbar'; // Adjust the import path as necessary
    ...
    const [notifications, setNotifications] = useState([
        {
            id: 1,
            title: 'Laptop ',
            message: 'Update laptop statuses and conditions.',
            read: false,
            type: 'Task',
        },
        {
        ...
        },
        {
            ...
            message: "3 broken laptops received.",
            read: false,
            type: 'Event',
        },
    ]);
